...
Schema-Format: Mistral-Function-Declarations (JSON-Schema-Subset).
Pflicht: 5 HeyLou-Capabilities (search_hotels / get_rates / compare_otas / book_direct / optimize_revenue).

Mistral-Reference: see vendor docs
...
# === HEYLOU FUNCTION DEFINITIONS (Mistral-Format) ===
...
def build_tool_payload() -> dict[str, Any]:
    ...
    Mistral accepts tools as: {"function_declarations": [...]}
    """
