"""Mistral-Extension fuer HeyLou [CRUX-MK].

Welle-39 LLM Sub-Funktion. Routet Mistral-functionCalls -> HeyLou-Backends.
...
class MistralExtension:
    """HeyLou-Extension fuer Gemini Function-Calling.

    Routet Gemini-functionCall-Parts an HeyLou-Backends.
    Sandbox-Default per ENV-Var DF_HEYLOU_MISTRAL_EXT_ENABLED.
    """

    EXTENSION_ID = "df-heylou-mistral-extension"
    PROVIDER = "mistral"
    REAL_ENV_VAR = "DF_HEYLOU_MISTRAL_EXT_ENABLED"
